...
from algorithm.gaps.individual import Individual
# from algorithm.gaps.plot import Plot
from algorithm.gaps.image_analysis import ImageAnalysis
from algorithm.gaps.selection import roulette_selection
from algorithm.gaps.crossover import Crossover
from algorithm.gaps.progress_bar import print_progress
...
class GeneticAlgorithm(object):
    ...
    def start_evolution(self, verbose=False, queue=None):
        ...
        ImageAnalysis.analyze_image(self._pieces,queue=queue)
        ...
        for generation in range(self._generations):
            print_progress(generation, self._generations - 1, prefix="Solving puzzle: ",queue=queue,is_finished=False)
