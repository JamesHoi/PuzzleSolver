from algorithm.gaps.fitness import dissimilarity_measure
...
class ImageAnalysis(object):
    ...
    @classmethod
    def analyze_image(cls, pieces, queue=None):
        for piece in pieces:
        ...
        for first in range(iterations):
            print_progress(first, iterations - 1, prefix="Analyzing image: ",queue=queue, is_finished=False)
